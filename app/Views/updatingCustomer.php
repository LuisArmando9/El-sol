  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        ...
        <?php if (isset($data)) : ?>
          <br />
            <form id="demo-form2" action=<?= base_url('UpdatingCustomer')."/".$data['idCustomer']?> method="Post" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="first-name"  name="FullName" value='<?=$data['FullName']?>' class="form-control ">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="last-name" name="Phone"  value=<?= $data['Phone'] ?> class="form-control">
                </div>
              </div>
              <div class="item form-group">
