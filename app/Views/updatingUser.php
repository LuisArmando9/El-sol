        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <br />
                    <?php if (isset($data)) : ?>
                        <form action=<?= base_url('UpdatingUser')."/".$data['idUser'] ?> method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" class="form-control " value='<?= $data['FullName'] ?>' accesskey="" name="FullName">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="last-name" name="UserName" value=<?= $data['UserName'] ?> class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="email" id="last-name" name="Email" value=<?=$data['Email']?> class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="password" id="last-name" name="ConfirmPassword" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="last-name" name="Phone" class="form-control" value=<?= $data['Phone'] ?>>
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3" id="insertImage">
                                    <img width="200" height="200" src=<?=  App\Controllers\Constant\FileConstant::PATH_TO_USER_IMAGES_TO_LOCALHOST. $data['Photo'] ?> />
                                </div>
                            </div>
